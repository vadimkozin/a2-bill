...
const headCells = [
  { id: 'name', numeric: false, disablePadding: true, label: 'Dessert (1g)' },
  { id: 'calories', numeric: true, disablePadding: false, label: 'Calor..' },
  { id: 'fat', numeric: true, disablePadding: false, label: 'Fat (g)' },
  { id: 'carbs', numeric: true, disablePadding: false, label: 'Carbs (g)' },
  { id: 'protein', numeric: true, disablePadding: false, label: 'Prot..(g)' },
];
